...
module.exports.run = async (bot, message, args ) => {
    message.delete()
    if(message.content.toLowerCase() === '!wl' && message.channel.id === '789590550390636574') {
        message.delete()
        let guild = message.guild;
        let channelc = await guild.createChannel(`whitelist-${message.author.username}`,{
            type: 'text',
            parent: '789590145371340862',
                    ...
                    id.on("collect", () => {
                        ...
                        con.connect(function(err) {
                            ...
                            con.query(sql, function (err, result) {
                                ...
                                bot.channels.get("789591041400635462").send(`O ID ${id.collected.first().content} foi adicionado com sucesso`)
                            })
                        })
